...
wget https://raw.githubusercontent.com/salo50/gseed/master/galileld -O /usr/local/bin/galileld
wget https://raw.githubusercontent.com/salo50/gseed/master/galilel-cli -O /usr/local/bin/galilel-cli
